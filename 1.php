...
session_start();
 ...
 $con = mysqli_connect("localhost:3307",'root',"",'demo') or die('Could not connect to database');
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <!-- <div class="dropdown-menu" aria-labelledby="navbarDropdown"> -->
              ...
              <option class="dropdown-item" value="Diuretic">Diuretics</option>
              <option class="dropdown-item" value="Antifungal">Antifungal</option>
